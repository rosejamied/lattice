            ...
            pallets.length > 0 ? (
              <div className="space-y-4">
                {pallets.map((pallet, index) => (
                  <div key={pallet.id} className="p-3 bg-gray-900/50 rounded-lg border border-gray-700">
                    ...
                    <DetailRow label="Received Date" value={pallet.inboundDate ? new Date(pallet.inboundDate).toLocaleDateString('en-GB') : 'N/A'} />
